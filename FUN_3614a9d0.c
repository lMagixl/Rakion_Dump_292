...
void __fastcall FUN_3614a9d0(undefined4 param_1,int param_2)

{
  ...
  *(uint *)(param_2 + 0x78) = (uint)*(ushort *)(&DAT_3623ac2a + iVar1);
  *(uint *)(param_2 + 0x84) = (uint)*(ushort *)(&DAT_3623ac28 + iVar1);
  *(uint *)(param_2 + 0x88) = (uint)*(ushort *)(&DAT_3623ac2c + iVar1);
  *(uint *)(param_2 + 0x74) = (uint)*(ushort *)(&DAT_3623ac2e + iVar1);
