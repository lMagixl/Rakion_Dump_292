...
/* public: void __thiscall CBrushArchive::WriteEntitySectorLinks_t(class CTStream &) */

void __thiscall CBrushArchive::WriteEntitySectorLinks_t(CBrushArchive *this,CTStream *param_1)

{
  ...
  undefined4 local_4;
                    ...
                    /* 0x1369a0  3967  ?WriteEntitySectorLinks_t@CBrushArchive@@QAEXAAVCTStream@@@Z
                        */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_36219300;
  local_c = ExceptionList;
  ExceptionList = &local_c;
  MakeIndices(this);
  local_20 = DAT_36238884;
  local_24 = DAT_36238880;
      ...
      while (*piVar5 != 0) {
        ...
        if (0 < iVar2) {
          do {
            ...
            lVar1 = CListHead::Count((CListHead *)(iVar2 + 0x9c));
            if (lVar1 != 0) {
              ...
              *(long *)(iVar7 + 4) = lVar1;
              *(int *)(param_1 + 0x14) = *(int *)(param_1 + 0x14) + 4;
              for (piVar6 = *(int **)(iVar2 + 0x9c); *piVar6 != 0; piVar6 = (int *)*piVar6) {
                pCVar3 = CRelationLnk::GetDst((CRelationLnk *)(piVar6 + -2));
                **(undefined4 **)(param_1 + 0x14) = *(undefined4 *)(pCVar3 + -0x90);
                *(int *)(param_1 + 0x14) = *(int *)(param_1 + 0x14) + 4;
              }
            }
            iVar7 = local_1c + 1;
  ...
  *(int *)(param_1 + 0x14) = *(int *)(param_1 + 0x14) + 4;
  ...
  local_1c = DAT_36238888;
  local_18 = (int *)CONCAT31(local_18._1_3_,DAT_3623888c);
