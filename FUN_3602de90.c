...
void __thiscall
FUN_3602de90(void *this,undefined4 *param_1,char param_2,undefined4 *param_3,undefined4 *param_4)

{
  ...
  ExceptionList = &local_c;
  piVar3 = (int *)FUN_3602d1f0(*(undefined4 *)((int)this + 4),param_3,*(undefined4 *)((int)this + 4)
                               ,param_4,0);
...
LAB_3602df98:
        ...
        *(undefined1 *)(*(int *)(*piVar4 + 4) + 0x10) = 0;
        ...
        if (piVar6 == (int *)piVar2[2]) {
          FUN_3602c770(this,(int)piVar2);
          piVar6 = piVar2;
        }
        *(undefined1 *)(piVar6[1] + 0x10) = 1;
        *(undefined1 *)(*(int *)(piVar6[1] + 4) + 0x10) = 0;
        FUN_3602c7d0(this,*(int **)(piVar6[1] + 4));
      }
    }
    else {
      if ((char)piVar5[4] == '\0') goto LAB_3602df98;
      if (piVar6 == (int *)*piVar2) {
        FUN_3602c7d0(this,piVar2);
        piVar6 = piVar2;
      }
      *(undefined1 *)(piVar6[1] + 0x10) = 1;
      *(undefined1 *)(*(int *)(piVar6[1] + 4) + 0x10) = 0;
      FUN_3602c770(this,*(int *)(piVar6[1] + 4));
    }
