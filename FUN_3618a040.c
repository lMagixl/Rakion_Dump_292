...
void __thiscall FUN_3618a040(void *this,undefined4 *param_1,uint param_2,undefined4 *param_3)

{
  ...
  if (param_2 != 0) {
    ...
    if (uVar2 < iVar1 + param_2) {
      ...
      _Dst = FUN_36189fd0((undefined4 *)((int)pvVar4 + _Size),param_2,&param_3);
    ...
    if ((uint)(iVar5 - (int)param_1 >> 2) < param_2) {
      FUN_36189c40(param_1,iVar5,param_1 + param_2);
      FUN_36189fd0(*(undefined4 **)((int)this + 8),
                   param_2 - ((int)*(undefined4 **)((int)this + 8) - (int)param_1 >> 2),&param_3);
      iVar5 = *(int *)((int)this + 8) + param_2 * 4;
      *(int *)((int)this + 8) = iVar5;
      FUN_361891d0(param_1,(undefined4 *)(iVar5 + param_2 * -4),&param_3);
      return;
    }
    pvVar3 = (void *)(iVar5 + param_2 * -4);
    pvVar4 = FUN_36189c40(pvVar3,iVar5,(void *)iVar5);
    *(void **)((int)this + 8) = pvVar4;
    FUN_36189820(param_1,(int)pvVar3,iVar5);
    FUN_361891d0(param_1,param_1 + param_2,&param_3);
  }
  return;
}
