...
int * __thiscall FUN_360b40f0(void *this,int param_1)
  ...
  if (piVar1 == (int *)0x0) {
    ...
    *piVar1 = iVar3;
    _eh_vector_constructor_iterator_
              (piVar4,8,iVar3,(_func_void_void_ptr *)&LAB_360b3e20,
               (_func_void_void_ptr *)&LAB_360b1610);
  }
  local_4 = 0xffffffff;
