...
/* public: int __thiscall CMessageDispatcher::ReceiveFromClientReliable(long,class CNetworkMessage
   &) */

int __thiscall
CMessageDispatcher::ReceiveFromClientReliable
...

{
  ...
  int iVar1;
                    ...
                    /* 0x103e90  3063
                       ?ReceiveFromClientReliable@CMessageDispatcher@@QAEHJAAVCNetworkMessage@@@Z */
  this_00 = param_2;
  *(long *)(param_2 + 0x10) = *(long *)(param_2 + 8);
  iVar1 = CCommunicationInterface::Server_Receive_Reliable
