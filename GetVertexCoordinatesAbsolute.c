...
/* public: void __thiscall CBrushPolygonEdge::GetVertexCoordinatesAbsolute(class Vector<float,3>
...

{
  int iVar1;
                    ...
                    /* 0x41a0  2193
                       ?GetVertexCoordinatesAbsolute@CBrushPolygonEdge@@QAEXAAV?$Vector@M$02@@0@Z */
  if (*(int *)(this + 4) != 0) {
    iVar1 = *(int *)(*(int *)this + 4);
    *(undefined4 *)param_1 = *(undefined4 *)(iVar1 + 4);
    *(undefined4 *)(param_1 + 4) = *(undefined4 *)(iVar1 + 8);
    *(undefined4 *)(param_1 + 8) = *(undefined4 *)(iVar1 + 0xc);
    iVar1 = **(int **)this;
    *(undefined4 *)param_2 = *(undefined4 *)(iVar1 + 4);
