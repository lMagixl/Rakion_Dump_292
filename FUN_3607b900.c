...
void __cdecl FUN_3607b900(int param_1)

{
  ...
  iVar4 = DAT_362bef7c;
  if ((DAT_362c44d4 != param_1) && (DAT_362c44d4 = param_1, *(int *)(_pGfx + 0xa38) == 0)) {
    if (1 < _iStatsMode) {
      puVar5 = (undefined4 *)CTimer::GetHighPrecisionTimer(_pTimer);
      *(undefined4 *)(iVar4 + 0x268) = *puVar5;
      *(undefined4 *)(iVar4 + 0x26c) = puVar5[1];
    }
    (*DAT_362c446c)(param_1 + 0x84c0);
    (*DAT_362c4470)(param_1 + 0x84c0);
    iVar4 = DAT_362bef7c;
    if (1 < _iStatsMode) {
