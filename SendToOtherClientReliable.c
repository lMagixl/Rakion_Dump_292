...
/* public: void __thiscall CNet::SendToOtherClientReliable(unsigned short,class CNetMessage &) */

void __thiscall CNet::SendToOtherClientReliable(CNet *this,ushort param_1,CNetMessage *param_2)

{
  ...
  char *pcStack_4;
                    ...
                    /* 0x105630  3363  ?SendToOtherClientReliable@CNet@@QAEXGAAVCNetMessage@@@Z */
  ...
  do {
    if ((((pcStack_4[0x2a] == '\0') && (*pcStack_4 == '\x03')) && ((uStack_c & 0xff) != uVar5)) &&
      ...
      SendData_Reliable(this,&param_1,(uchar *)&uStack_c,(uchar *)&param_2,pCVar1);
      *(undefined2 *)(pCVar1 + 0x3ec) = 0;
      uVar4 = _param_1;
    }
