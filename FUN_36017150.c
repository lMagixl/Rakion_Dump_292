...
_String_base * __thiscall FUN_36017150(void *this,_String_base *param_1,uint param_2)

{
  ...
  if (p_Var2 <= param_1) {
    ...
    if (param_1 < (_String_base *)(*(int *)((int)this + 0x14) + (int)puVar3)) {
      ...
      p_Var2 = FUN_36016fb0(this,this,(int)param_1 - (int)puVar1,param_2,unaff_EDI);
      return p_Var2;
    }
  }
  ...
  if (*(uint *)((int)this + 0x18) < param_2) {
    FUN_36013960(this,param_2,*(uint *)((int)this + 0x14));
  }
  else if (param_2 == 0) {
