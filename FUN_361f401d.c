...
void __cdecl
FUN_361f401d(uint param_1,undefined4 *param_2,undefined4 *param_3,undefined4 *param_4,
...

{
  ...
  do {
    ...
    uVar30 = CONCAT22((short)DAT_36383ca4,
                      (short)(CONCAT35(CONCAT21(uVar16,(char)((uint)DAT_36383ca0 >> 0x10)),
                                       CONCAT14((char)((uint)uVar30 >> 0x10),uVar30)) >> 0x20));
    uVar13 = (uint)DAT_36383ca4 >> 0x10;
    *param_6 = CONCAT17((0 < sVar9) * (sVar9 < 0x100) * (char)((ulonglong)uVar19 >> 0x30) -
    ...
    uVar17 = packssdw(CONCAT44((int)((int)((ulonglong)uVar27 >> 0x20) +
                      ...
                      CONCAT44((int)(CONCAT26((short)uVar13,CONCAT24(uVar16,uVar30)) >> 0x20),
