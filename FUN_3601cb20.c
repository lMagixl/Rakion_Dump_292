...
FUN_3601cb20(void *this,_String_base *param_1,uint param_2,uint param_3,uint param_4)

{
  ...
  if (this != param_1) {
    ...
    if (*(uint *)((int)this + 0x18) < uVar4) {
      FUN_3601a6f0(this,uVar4,*(uint *)((int)this + 0x14));
    }
    else if (uVar4 == 0) {
  ...
  FUN_3600ed70(this,uVar4 + param_2,0xffffffff,unaff_ESI);
  FUN_3600ed70(this,0,param_2,unaff_ESI);
  return this;
}
