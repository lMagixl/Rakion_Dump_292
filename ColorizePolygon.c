...
/* public: void __thiscall CModelObject::ColorizePolygon(class CDrawPort *,class CProjection3D
   *,long,long,long,int) */

void __thiscall
CModelObject::ColorizePolygon
...

{
  ...
  undefined4 uStack_c;
                    ...
                    /* 0xb8db0  1344
                       ?ColorizePolygon@CModelObject@@QAEXPAVCDrawPort@@PAVCProjection3D@@JJJH@Z */
  ...
  if (pMVar1 != (ModelPolygon *)0x0) {
    ...
    if (param_4 != 0) {
      *(int *)(iVar3 + 0x40) = 1 << ((byte)param_3 & 0x1f);
      return;
    }
    *(int *)(iVar3 + 0x44) = 1 << ((byte)param_3 & 0x1f);
  }
  return;
}
