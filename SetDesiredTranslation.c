...
/* public: void __thiscall CMovableEntity::SetDesiredTranslation(class Vector<float,3> const &) */

void __thiscall CMovableEntity::SetDesiredTranslation(CMovableEntity *this,Vector<float,3> *param_1)

{
  ...
  int iVar7;
                    ...
                    /* 0x1aaf50  3441
                       ?SetDesiredTranslation@CMovableEntity@@QAEXABV?$Vector@M$02@@@Z */
  fVar1 = *(float *)(this + 0x120);
  fVar2 = *(float *)param_1;
  fVar3 = *(float *)(this + 0x124);
  fVar4 = *(float *)(param_1 + 4);
  fVar5 = *(float *)(this + 0x128);
  ...
  if (*(int *)(_pNetwork + 0x14) != 0) {
    ...
    if (iVar7 != 0) {
      ...
      if ((iVar7 == 0) &&
         (_DAT_362a604c <= ABS(fVar1 - fVar2) + ABS(fVar5 - fVar6) + ABS(fVar3 - fVar4))) {
