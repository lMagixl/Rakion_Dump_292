...
int * __thiscall FUN_360b41a0(void *this,int param_1)
  ...
  if (piVar1 == (int *)0x0) {
    ...
    *piVar1 = iVar3;
    _eh_vector_constructor_iterator_
              (piVar4,8,iVar3,(_func_void_void_ptr *)&LAB_360b2c20,
               (_func_void_void_ptr *)&LAB_360b2c70);
  }
  local_4 = 0xffffffff;
