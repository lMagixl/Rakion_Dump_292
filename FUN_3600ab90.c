...
facet * __cdecl FUN_3600ab90(locale *param_1)

{
  ...
  local_4 = 0xffffffff;
  puStack_8 = &LAB_3620d629;
  local_c = ExceptionList;
  ExceptionList = &local_c;
  std::_Lockit::_Lockit(local_1c,0);
  pcVar1 = id_exref;
  local_24 = DAT_362b8dfc;
  local_4 = 0;
  if (*(int *)id_exref == 0) {
  ...
  if ((this == (facet *)0x0) && (this = local_24, local_24 == (facet *)0x0)) {
    uVar2 = std::ctype<unsigned_short>::_Getcat(&local_24);
    this = local_24;
    if (uVar2 == 0xffffffff) {
