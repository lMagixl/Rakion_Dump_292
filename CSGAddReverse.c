...
/* public: void __thiscall CWorld::CSGAddReverse(class CEntity &,class CWorld &,class CEntity
   &,class CPlacement3D const &) */

void __thiscall
CWorld::CSGAddReverse
          (CWorld *this,CEntity *param_1,CWorld *param_2,CEntity *param_3,CPlacement3D *param_4)

{
                    /* 0xd52e0  1107
                       ?CSGAddReverse@CWorld@@QAEXAAVCEntity@@AAV1@0ABVCPlacement3D@@@Z */
  DoCSGOperation(this,param_1,param_2,param_3,param_4,CObject3D::CSGAddMaterialReverse,
