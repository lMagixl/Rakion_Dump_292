...
/* public: void __thiscall CCastRay::TestSkaModelFull(class CEntity *,class CModelInstance &) */

void __thiscall CCastRay::TestSkaModelFull(CCastRay *this,CEntity *param_1,CModelInstance *param_2)

{
  ...
  float local_4;
                    ...
                    /* 0xdd030  3814
                       ?TestSkaModelFull@CCastRay@@QAEXPAVCEntity@@AAVCModelInstance@@@Z */
  pCVar1 = param_2;
  local_18 = 3e+38;
  local_c = -3e+38;
  local_14 = 3e+38;
  ...
  local_10 = 3e+38;
  local_4 = -3e+38;
  CModelInstance::GetAllFramesBBox(param_2,(AABBox<float,3> *)&local_18);
  ...
  if (iVar2 != 0) {
    param_2 = *(CModelInstance **)(this + 0x94);
    local_40 = -1;
    if (*(int *)(this + 0x9c) == 0) {
      plVar4 = (long *)0x0;
    }
    ...
    fVar3 = RM_TestRayCastHit(pCVar1,(Matrix<float,3,3> *)(param_1 + 0x54),
                              (Vector<float,3> *)(param_1 + 0x3c),(Vector<float,3> *)(this + 0x2c),
                              (Vector<float,3> *)(this + 0x38),(float)param_2,plVar4);
