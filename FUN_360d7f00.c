...
void __fastcall FUN_360d7f00(int *param_1)

{
  ...
  if (0 < *param_1) {
    ...
    pcVar5 = Translate(s_ETRSHash_table_efficiency_report_36232144,4);
    CPrintF(pcVar5);
    pcVar5 = Translate(s_ETRS_Compartments___ld__Slots_pe_36232168,4);
    CPrintF(pcVar5);
    dVar13 = (dVar4 / (double)(iVar10 * iVar7)) * _DAT_362255b0;
    dVar15 = dVar3;
    pcVar5 = Translate(s_ETRS_Percentage_of_full_slots____362321b0,4);
    CPrintF(pcVar5,dVar13,dVar15);
    uVar16 = CONCAT44(local_38,local_34);
    pcVar5 = Translate(s_ETRS_Max_slots_full___ld__Min_sl_36232208,4);
    ...
    ;
    pcVar5 = Translate(s_ETRS_Standard_deviation_is___5_2_3623223c,4);
    CPrintF(pcVar5,dVar17);
    pcVar5 = Translate(s_ETRS_Distribution_of_number_of_f_36232260,4);
    CPrintF(pcVar5);
    iVar7 = 0;
    if (0 < param_1[1]) {
      do {
        ...
        pcVar5 = Translate(s_ETRS__d_slots_full_in__4d___5_2f_362322a0,4);
  ...
  pcVar5 = Translate(s_I_ETRSHashTable_not_initialized__36232122 + 2,4);
  CPrintF(pcVar5);
  return;
}
