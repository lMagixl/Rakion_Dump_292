...
/* public: void __thiscall CPlacement3D::RelativeToRelativeSmooth(class CPlacement3D const &,class
   CPlacement3D const &) */

void __thiscall
CPlacement3D::RelativeToRelativeSmooth
          (CPlacement3D *this,CPlacement3D *param_1,CPlacement3D *param_2)

{
  ...
  undefined4 local_148;
                    ...
                    /* 0x56590  3082  ?RelativeToRelativeSmooth@CPlacement3D@@QAEXABV1@0@Z */
