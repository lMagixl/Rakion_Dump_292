...
void __thiscall FUN_3602cee0(void *this,undefined4 *param_1,int *param_2)

{
  ...
  if ((int *)*piVar6 == piVar2) {
    piVar3 = piVar5;
    if (*(char *)((int)piVar7 + 0x11) == '\0') {
      piVar3 = (int *)FUN_3602bc80(piVar7);
    }
    *piVar6 = (int)piVar3;
  }
