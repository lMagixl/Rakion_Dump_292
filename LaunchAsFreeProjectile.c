...
/* public: void __thiscall CMovableEntity::LaunchAsFreeProjectile(class Vector<float,3> const
   &,class CMovableEntity *) */

void __thiscall
CMovableEntity::LaunchAsFreeProjectile
...

{
  ...
  float local_4;
                    ...
                    /* 0x1adee0  2530
                       ?LaunchAsFreeProjectile@CMovableEntity@@QAEXABV?$Vector@M$02@@PAV1@@Z */
