...
/* public: int __thiscall CClipTest::CheckForCollisionPolygon(class CEntity *,long,class
   CBrushPolygon * *) */

int __thiscall
CClipTest::CheckForCollisionPolygon
          (CClipTest *this,CEntity *param_1,long param_2,CBrushPolygon **param_3)

{
  ...
  undefined4 local_4;
                    ...
                    /* 0x1311a0  1170
                       ?CheckForCollisionPolygon@CClipTest@@QAEHPAVCEntity@@JPAPAVCBrushPolygon@@@Z
                        */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_36218e6f;
