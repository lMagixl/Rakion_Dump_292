...
void __thiscall FUN_3601c8f0(void *this,undefined4 *param_1,_String_base *param_2)
    ...
    if (_Var1 != (_String_base)0x0) {
      ...
      if (local_8) {
        if (p_Var8 == (_String_base *)**(int **)((int)this + 4)) {
          puVar6 = (undefined4 *)FUN_3601b7d0(this,&param_2,'\x01',(undefined4 *)p_Var8,p_Var3);
          *param_1 = *puVar6;
          *(undefined1 *)(param_1 + 1) = 1;
          return;
        }
        FUN_3600a600((int *)&param_2);
      }
      p_Var9 = param_2;
      ...
      uVar7 = FUN_3600b580(param_2 + 0xc,0,*(undefined4 *)(param_2 + 0x20),(uint)p_Var4,
      ...
      puVar6 = (undefined4 *)FUN_3601b7d0(this,&param_2,local_8,(undefined4 *)p_Var8,p_Var3);
      *param_1 = *puVar6;
      *(undefined1 *)(param_1 + 1) = 1;
      return;
    }
