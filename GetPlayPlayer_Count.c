...
/* public: unsigned char __thiscall FieldInfo::GetPlayPlayer_Count(void) */

uchar __thiscall FieldInfo::GetPlayPlayer_Count(FieldInfo *this)

{
  ...
  int iVar4;
                    ...
                    /* 0x199dc0  2044  ?GetPlayPlayer_Count@FieldInfo@@QAEEXZ */
  uVar1 = '\0';
  pFVar3 = this + 0x48a8;
  pFVar2 = this + 0x528;
  iVar4 = 4;
