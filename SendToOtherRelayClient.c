...
/* public: void __thiscall CNet::SendToOtherRelayClient(unsigned short,class CNetMessage &) */

void __thiscall CNet::SendToOtherRelayClient(CNet *this,ushort param_1,CNetMessage *param_2)

{
  ...
  undefined4 uStack_4;
                    ...
                    /* 0x1055b0  3365  ?SendToOtherRelayClient@CNet@@QAEXGAAVCNetMessage@@@Z */
  uStack_4 = this;
