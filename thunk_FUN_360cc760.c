...
void __fastcall thunk_FUN_360cc760(undefined4 *param_1)

{
  ...
  if (param_1[4] != 0) {
    ...
    if (0 < (int)param_1[4]) {
      do {
        CTerrain::Clear(*(CTerrain **)(param_1[3] + iVar3 * 4));
        iVar3 = iVar3 + 1;
  ...
  while (pCVar1 = *(CListNode **)pCVar4, pCVar1 != (CListNode *)0x0) {
    ...
    if (pvVar2 != (void *)0x0) {
      _eh_vector_destructor_iterator_(pvVar2,0x30,*(int *)((int)pvVar2 + -4),CTerrain::~CTerrain);
