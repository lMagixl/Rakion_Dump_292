...
/* WARNING: Removing unreachable block (ram,0x361a1334) */

void __thiscall
FUN_361a1220(void *this,int *param_1,
...

{
  ...
  if (uVar9 <= *(uint *)((int)this + 0xc) >> 2) {
    ...
    if (uVar9 < iVar6 - 1U) {
      ...
      *(int *)((int)this + 0x20) = iVar6 * 2 + -3;
      FUN_361a1000((void *)((int)this + 0x10),iVar6 * 2 - 1);
    }
  ...
  puVar7 = FUN_361a08c0(puVar12,puVar12[1],param_2);
  FUN_361a03a0((void *)((int)this + 4),1);
  puVar12[1] = puVar7;
