...
void FUN_361c6851(float *param_1,float *param_2,float *param_3,float *param_4)

{
  ...
  *param_1 = fVar1;
  param_1[0xc] = -(fVar3 * param_2[2] + fVar2 * param_2[1] + fVar1 * *param_2);
  param_1[1] = fVar7;
  param_1[5] = fVar9;
  param_1[9] = fVar8;
  fVar1 = *param_2;
  ...
  param_1[6] = fVar5;
  param_1[10] = fVar6;
  param_1[0xd] = -(fVar8 * fVar3 + fVar9 * fVar2 + fVar7 * fVar1);
  param_1[0xe] = -(fVar6 * param_2[2] + fVar5 * param_2[1] + fVar4 * *param_2);
  param_1[3] = 0.0;
  param_1[7] = 0.0;
  param_1[0xb] = 0.0;
  param_1[0xf] = 1.0;
