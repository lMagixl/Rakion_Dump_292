...
/* public: void __thiscall CCastRay::TestModelSimple(class CEntity *,class CModelObject &) */

void __thiscall CCastRay::TestModelSimple(CCastRay *this,CEntity *param_1,CModelObject *param_2)

{
  ...
  float local_4;
                    ...
                    /* 0xdc4e0  3810  ?TestModelSimple@CCastRay@@QAEXPAVCEntity@@AAVCModelObject@@@Z
                        */
  pCVar1 = param_2;
  local_18 = 3e+38;
  local_c = -3e+38;
  ...
  local_10 = 3e+38;
  local_4 = -3e+38;
  CModelObject::GetCurrentFrameBBox(param_2,(AABBox<float,3> *)&local_18);
  local_c = local_c * ABS(*(float *)(pCVar1 + 0x84));
  local_18 = ABS(*(float *)(pCVar1 + 0x84)) * local_18;
  local_8 = local_8 * ABS(*(float *)(pCVar1 + 0x88));
  local_14 = ABS(*(float *)(pCVar1 + 0x88)) * local_14;
  local_4 = local_4 * ABS(*(float *)(pCVar1 + 0x8c));
  local_10 = ABS(*(float *)(pCVar1 + 0x8c)) * local_10;
