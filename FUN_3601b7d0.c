...
void __thiscall
FUN_3601b7d0(void *this,undefined4 *param_1,char param_2,undefined4 *param_3,_String_base *param_4)

{
  ...
  local_4 = 0xffffffff;
  puStack_8 = &LAB_3620e752;
  local_c = ExceptionList;
  if (0x1a41a3f < *(uint *)((int)this + 8)) {
  ...
  ExceptionList = &local_c;
  piVar3 = FUN_3601a650(*(undefined4 *)((int)this + 4),param_3,*(undefined4 *)((int)this + 4),
                        param_4,0);
  *(int *)((int)this + 8) = *(int *)((int)this + 8) + 1;
  ...
  cVar1 = *(char *)(piVar3[1] + 0xa8);
  piVar6 = piVar3;
  do {
    if (cVar1 != '\0') {
      *(undefined1 *)(*(int *)(*(int *)((int)this + 4) + 4) + 0xa8) = 1;
      *param_1 = piVar3;
      ExceptionList = local_c;
      return;
    }
...
LAB_3601b8de:
        *(undefined1 *)(*piVar4 + 0xa8) = 1;
        *(undefined1 *)(piVar5 + 0x2a) = 1;
        *(undefined1 *)(*(int *)(*piVar4 + 4) + 0xa8) = 0;
        piVar6 = *(int **)(*piVar4 + 4);
      }
      else {
        if (piVar6 == (int *)piVar2[2]) {
          FUN_3600ea00(this,(int)piVar2);
          piVar6 = piVar2;
        }
        *(undefined1 *)(piVar6[1] + 0xa8) = 1;
        *(undefined1 *)(*(int *)(piVar6[1] + 4) + 0xa8) = 0;
        FUN_3600ea60(this,*(int **)(piVar6[1] + 4));
      }
    }
    else {
      if ((char)piVar5[0x2a] == '\0') goto LAB_3601b8de;
      if (piVar6 == (int *)*piVar2) {
        FUN_3600ea60(this,piVar2);
        piVar6 = piVar2;
      }
      *(undefined1 *)(piVar6[1] + 0xa8) = 1;
      *(undefined1 *)(*(int *)(piVar6[1] + 4) + 0xa8) = 0;
      FUN_3600ea00(this,*(int *)(piVar6[1] + 4));
    }
    cVar1 = *(char *)(piVar6[1] + 0xa8);
  } while( true );
}
