...
undefined4 __cdecl FUN_3607bcf0(int *param_1,int param_2,int param_3,int param_4,int param_5)

{
  ...
  uVar10 = 0;
  if (iVar1 == 0) {
    uVar10 = FUN_3607a970(param_1,param_2,param_3,param_4,param_5);
  }
  else if (iVar1 == 1) {
    piVar2 = *(int **)(&DAT_362c4564 + DAT_362c44d4 * 4);
    iVar1 = *piVar2;
    uVar10 = FUN_36076620(piVar2);
    if (iVar1 != *piVar2) {
