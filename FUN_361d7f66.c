...
/* WARNING: Removing unreachable block (ram,0x361d7fc9) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall FUN_361d7f66(void *this,int param_1,int param_2,float *param_3)

{
  ...
  for (; puVar3 < puVar1; puVar3 = puVar3 + 1) {
    *param_3 = (float)*(byte *)((int)puVar3 + 2) * fVar2;
    ...
    param_3[3] = (float)*(byte *)((int)puVar3 + 3) * fVar2;
    param_3 = param_3 + 4;
  }
