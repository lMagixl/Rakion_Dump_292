...
void __cdecl FUN_36100470(CTStream *param_1,CTStream *param_2,undefined4 param_3)

{
  ...
  *(uint *)(param_2 + 0x14) = *(int *)(param_2 + 0x14) + uVar1;
  ...
  FUN_3603d6a0(&DAT_362cf504,(int)DAT_362cf51c,DAT_362cf520);
