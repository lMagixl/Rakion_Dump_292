...
/* public: void __thiscall CEntityMessage::ReadAddSkaString(long &,class CTString &) */

void __thiscall
CEntityMessage::ReadAddSkaString(CEntityMessage *this,long *param_1,CTString *param_2)

{
  ...
  uint uVar4;
                    ...
                    /* 0x1021b0  2948  ?ReadAddSkaString@CEntityMessage@@QAEXAAJAAVCTString@@@Z */
