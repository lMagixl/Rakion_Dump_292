...
/* WARNING: Removing unreachable block (ram,0x3618ad34) */

void __thiscall
FUN_3618ac20(void *this,int *param_1,
...

{
  ...
  if (uVar9 <= *(uint *)((int)this + 0xc) >> 2) {
    ...
    if (uVar9 < iVar6 - 1U) {
      ...
      *(int *)((int)this + 0x20) = iVar6 * 2 + -3;
      FUN_3618aa00((void *)((int)this + 0x10),iVar6 * 2 - 1);
    }
  ...
  puVar7 = FUN_3618a580(puVar12,puVar12[1],param_2);
  FUN_36189ab0((void *)((int)this + 4),1);
  puVar12[1] = puVar7;
