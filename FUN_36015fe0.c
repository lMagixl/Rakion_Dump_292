...
undefined4 * __thiscall FUN_36015fe0(void *this,int param_1)
...
LAB_36016053:
      ...
      if (uVar5 == 0) goto LAB_36016044;
LAB_36016051:
      if ((int)uVar5 < 0) goto LAB_36016053;
      puVar6 = (undefined4 *)puVar4[2];
    }
    cVar1 = *(char *)((int)puVar6 + 0xa9);
    puVar4 = puVar6;
  } while( true );
}
