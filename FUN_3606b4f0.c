...
void __thiscall FUN_3606b4f0(void *this,undefined4 *param_1,uint param_2,undefined4 *param_3)

{
  ...
  if (param_2 != 0) {
    ...
    if (uVar3 < iVar2 + param_2) {
      ...
      local_8 = 0;
      puVar5 = (undefined4 *)FUN_3606b2e0(*(undefined4 **)((int)this + 4),param_1,puVar4);
      FUN_3606b390(puVar5,param_2,&param_3);
      FUN_3606b2e0(param_1,*(undefined4 **)((int)this + 8),puVar5 + param_2);
    ...
    if ((uint)((int)puVar4 - (int)param_1 >> 2) < param_2) {
      FUN_3606b2e0(param_1,puVar4,param_1 + param_2);
      local_8 = 2;
      FUN_3606b460(*(undefined4 **)((int)this + 8),
                   param_2 - ((int)*(undefined4 **)((int)this + 8) - (int)param_1 >> 2),&param_3);
      iVar7 = *(int *)((int)this + 8) + param_2 * 4;
      *(int *)((int)this + 8) = iVar7;
      FUN_3606b090(param_1,(undefined4 *)(iVar7 + param_2 * -4),&param_3);
      ExceptionList = local_10;
      return;
    }
    uVar6 = FUN_3606b2e0(puVar4 + -param_2,puVar4,puVar4);
    *(undefined4 *)((int)this + 8) = uVar6;
    FUN_3606b220((int)param_1,(int)(puVar4 + -param_2),puVar4);
    FUN_3606b090(param_1,param_1 + param_2,&param_3);
  }
  ExceptionList = local_10;
  return;
}
