...
void __thiscall FUN_360e8b50(void *this,CTStream *param_1)

{
  ...
  local_20 = this;
  iVar2 = FUN_360e9110((int)this);
  if (0 < iVar2) {
    do {
      piVar3 = (int *)FUN_360e9120(this,iVar8);
      iStack_28 = (**(code **)(*piVar3 + 0x18))();
      if (iStack_28 < 0) {
        CTStream::PutLine_t(param_1,s_Error__362329b4);
        goto LAB_360e8d66;
      }
      ...
      local_4._0_1_ = 3;
      pCStack_34 = (CSerial *)FUN_360e9120(this,iVar8);
      iVar2 = FUN_360e9120(this,iVar8);
      uStack_30 = *(undefined4 *)(iVar2 + 0xc);
      uVar9 = *puStack_38;
      lVar4 = CSerial::GetUsedCount(pCStack_34);
      CTString::PrintF(this_02,(char *)&pcStack_3c,s__s__d___s_362329bc,uStack_30,lVar4,uVar9);
  ...
  if (0 < (int)_NumOfElements) {
    qsort(_Base,_NumOfElements,8,FUN_360e84d0);
  }
  this_01 = param_1;
  iVar7 = 0;
  if (0 < (int)_NumOfElements) {
    do {
      ...
      CTString::CTString(this_00,(long)&param_1,(char *)0x0,s__7_1fk__s_362329c8,
