...
/* public: long __thiscall CModelObject::PickPolySurface(class CDrawPort *,class CProjection3D
   *,long,long) */

long __thiscall
CModelObject::PickPolySurface
...

{
  ...
  undefined4 uStack_c;
                    ...
                    /* 0xb90c0  2764
                       ?PickPolySurface@CModelObject@@QAEJPAVCDrawPort@@PAVCProjection3D@@JJ@Z */
