...
void __thiscall FUN_361d81ef(void *this,int param_1,int param_2,float *param_3)

{
  ...
  for (; puVar3 < puVar1; puVar3 = puVar3 + 1) {
    *param_3 = (float)((*puVar3 & 0x7c00) >> 10) * fVar2;
    param_3[1] = (float)((*puVar3 & 0x3e0) >> 5) * fVar2;
    param_3[2] = (float)((byte)*puVar3 & 0x1f) * fVar2;
    param_3[3] = (float)(*puVar3 >> 0xf);
    param_3 = param_3 + 4;
  }
