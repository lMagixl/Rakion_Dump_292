...

{
  ...
  local_c = FUN_3615a300(puVar7 + 10);
  if (0 < local_c) {
    iVar2 = 0;
    do {
      iVar3 = puVar7[0xb];
      iVar4 = FUN_3600c450((undefined4 *)(iVar3 + iVar2 + 8));
      if (0 < iVar4) {
        iVar6 = 0;
        do {
          piVar1 = (int *)(iVar6 + *(int *)(iVar3 + iVar2 + 0xc));
          iVar6 = iVar6 + 0x1c;
          iVar4 = iVar4 + -1;
          DAT_362fe0b4[*piVar1] = DAT_362fe0b4[*piVar1] + 1;
        } while (iVar4 != 0);
      }
      iVar2 = iVar2 + 0x10;
      local_c = local_c + -1;
