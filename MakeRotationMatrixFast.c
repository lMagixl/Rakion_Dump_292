...
/* void __cdecl MakeRotationMatrixFast(class Matrix<float,3,3> &,class Vector<float,3> const &) */

void __cdecl MakeRotationMatrixFast(Matrix<float,3,3> *param_1,Vector<float,3> *param_2)

{
  ...
  float10 fVar7;
                    ...
                    /* 0x49110  2619
                       ?MakeRotationMatrixFast@@YAXAAV?$Matrix@M$02$02@@ABV?$Vector@M$02@@@Z */
  ...
  *(float *)(param_1 + 8) = (float)((float10)fVar2 * fVar5);
  *(float *)(param_1 + 0xc) = fVar3 * fVar2;
  *(float *)(param_1 + 0x10) = fVar4 * fVar2;
  *(float *)(param_1 + 0x14) = (float)-fVar6;
  *(float *)(param_1 + 0x18) =
